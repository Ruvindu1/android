...
\033[1;32;40m      Created By Rj Studio 2020

___________________________________________________________
\033[1;36;40m      __  __               _      ____        _   _       
\033[1;34;40m     |  \/  | ___  __ _   / \    |  _ \ _   _| \ | |    Hack
...
\033[1;32;40m_____________________________________________
"""
...
def main():
    ...
    while s > ss:
        ...
        if resp == '<Response [204]>':
            print(bar)
            print("\n\033[1;32;40m [wait] No Data ... [wait]")
            print(bar)  
        elif resp == '<Response [200]>':
            print(bar)
            print("\n\033[1;32;40m [be cool] You Won Check Balance ... [be cool]")
            print(bar)
        else:
            print(bar)
